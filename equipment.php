<?php
	...
	class equipment extends adb{
        ...
        function view_equipment($eid) {
            $str_query = "select equipment_id, serial_number, inventory_number, equipment_name, lab_id, supplier_id,
                        description from webtech_project_equipment where equipment_id=$eid";
            return $this->query($str_query);
        }
